 ...
 * @author Rafael
 */
public class subVentana2 extends JFrame {
    
    public JPanel panel;
    
    public subVentana2(){
        this.setSize(500,500);//Se establece el tamaño de ventana.
        this.setTitle("reclamos");//Se establece el titulo de la ventana
    ...
    private void colocarPaneles(){
        ...
        etiqueta1.setText("fidelización"); //establecemos el texto a la etiqueta
